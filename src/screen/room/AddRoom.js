      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.row}>
          ...
          <TextInput
            ...
            placeholder="VD: 10/10 Nguyễn Đình Chiểu"
          />
        </View>
        <View style={styles.row}>
          ...
          <TextInput
            ...
            value={this.state.roomCost}
            onChangeText={text => {
              const intMoney = parseInt(text.replace(/\./g, ""), 10);
              this.setState({
                roomCost: text === "" ? "" : this.styleMoney(intMoney)
              });
            }}
        ...
        <View style={styles.row}>
          ...
          <TextInput
            style={styles.data}
            keyboardType={"number-pad"}
            value={this.state.perElectricCost}
            onChangeText={text => {
              const intMoney = parseInt(text.replace(/\./g, ""), 10);
              this.setState({
                perElectricCost: text === "" ? "" : this.styleMoney(intMoney)
              });
            }}
            placeholder="VD: 3500đ/kWh"
          />
        </View>
        <View style={styles.row}>
          ...
          <TextInput
            style={styles.data}
            keyboardType={"number-pad"}
            value={this.state.perWaterCost}
            onChangeText={text => {
              const intMoney = parseInt(text.replace(/\./g, ""), 10);
              this.setState({
                perWaterCost: text === "" ? "" : this.styleMoney(intMoney)
              });
            }}
            placeholder="VD: 16000đ/m3"
          />
        </View>
        <MainButton
          title="Tạo phòng"
